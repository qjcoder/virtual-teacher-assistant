...
const Quiz = () => {
  const [questions, setQuestions] = useState([
    {
      que_no: 1,
      question: "How many seasons in your country?",
      correct_option: 2,
      options: ["Option 1", "Option 2", "Option 3", "Option 4"],
    },
    {
      que_no: 2,
      question: "How many province in Pakistan",
      correct_option: 1,
      options: ["Option 1", "Option 2", "Option 3", "Option 4"],
    },
  ]);
  ...
  return (
    <main className="h-screen bg-[#F9F9F9] rounded-2xl pl-5 ">
      ...
      <div className=" flex flex-col  pl-10 pr-28 pb-4  bg-white  rounded-3xl   ">
        <h1 className="flex items-center justify-center text-2xl font-bold text-[#CACED8] ">
          Quiz
        </h1>
          ...
          <div className="   flex mt-5 item flex-col mb-6  ">
            <div className="flex gap-8">
              ...
              <div className="flex flex-col">
                ...
                <select
                  required
                  className="w-[344px] h-[44px] rounded-lg border-[2px] solid border-[#CACED8] outline-none pl-4"
                >
